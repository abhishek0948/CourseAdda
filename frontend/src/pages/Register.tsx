...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.role === 'mentor' && response.user.approval_status === 'pending') {
        setSuccess('Registration successful! Your mentor account is pending admin approval.');
            ...
            <div>
              ...
              {formData.role === 'mentor' && (
                <p className="mt-1 text-xs text-amber-600">
                  Note: Mentor accounts require admin approval before access
                </p>
              )}
            </div>
          </div>
